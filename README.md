<h1><center>Los inventarios de datos en</center></h1>
<center>
...
En concreto, el contenido de este repositorio está enfocado a los inventarios de datos y su uso en SIMANFOR.


## Contenido:

*   ejemplos: inventarios de ejemplo, elaborados a partir de datos reales
*   plantillas: archivos diseñados para ser utilizados como inventarios de datos
*   SIMANFOR_inventarios.pdf: documento explicativo acerca de cómo rellenar un inventario de datos  
